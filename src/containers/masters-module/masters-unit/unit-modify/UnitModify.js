...
const UnitModify = (props) => {

    const formValue = {

    }

    const unit_modify_dropdown = [
        {
            name: 'selectUnitToModify',
            values: [
                "Dozen",
                "Gms.",
                "Kgs.",
        ...
        <div className="container containerWidth mt-4 mb-4">
            ...
            >
                ...
                {({ values, isSubmitting, handleChange }) => (
                    <Form>
                        <div className="text-center"><strong>Select Unit to Modify</strong></div>
                        <div className="row">

                            {
                                unit_modify_dropdown.map((val, index) => (
