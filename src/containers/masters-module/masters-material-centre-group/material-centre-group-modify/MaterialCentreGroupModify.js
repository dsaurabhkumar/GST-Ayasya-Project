...
const MaterialCentreGroupModify = (props) => {

    const formValue = {

    }

    const materialCentreGroupModify = [
        {
            name: 'selectMaterialCentreGroupToModify',
            values: [
                "Godowns",
                "Production Floors",
                "Stores"
                ...
                {({ values, isSubmitting, handleChange }) => (
                    <Form>
                        ...
                        <div className="row">
                            ...
                            {
                                materialCentreGroupModify.map((val, index) => (
...
export default MaterialCentreGroupModify